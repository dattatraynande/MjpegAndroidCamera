...
/* package */ public class CameraStreamer extends Object {
    ...
    /* package */
    public CameraStreamer(final int cameraIndex, final boolean useFlashLight, final int port,
        ...
        try {
            while (true) {
                try {
                    ...
                    //Broadcast camera open state
                    /*CameraState camState = new CameraState();
                    camState.setOpen(false);
                    EventBus.getDefault().post(camState);*/
    ...
    public void setDefault(){
        ...
        camera.setParameters(params);
        Log.d(TAG, "Camera setting : Set Default");
    }
    ...
    public void setBrightness(int brightness){
        if(camera!=null){
            ...
            }else if(brightness>45 && brightness<=55){
                params.setExposureCompensation(0);
            }else if(brightness>55 && brightness<=60){
                params.setExposureCompensation(1);
